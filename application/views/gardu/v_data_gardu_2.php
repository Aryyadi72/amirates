...
<br><br>
<div class="container">
    <button class="btn btn-primary" type="submit" style=margin-bottom:10px;>Submit form</button>
    <table id="example" class="display" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="text" id="row-4-position" name="row-4-position" value="Senior Javascript Developer">
                </td>
            ...
            <tr>
                ...
                <td><input type="text" id="row-14-position" name="row-14-position" value="Senior Marketing Designer">
                </td>
            ...
            <tr>
                ...
                <td><input type="text" id="row-50-position" name="row-50-position" value="Junior Javascript Developer">
                </td>
