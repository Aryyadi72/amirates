            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-9" style="margin-top:8px;margin-bottom:8px;">
                            <div class="progress">
                ...
                <td class="text-center">
                    ...
                    <!-- Lihat Dokumen -->
                    <a href="<?php echo base_url('k3/detail_dok/' . $k3->id_k3); ?>" target="_blank" style="margin-top:8px;><button
                ...
                <td class="text-center">
                    ...
                    <div class="modal fade" id="modalK32" tabindex="-1" aria-labelledby="modalK32Label"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="modalK32Label">Upload Dokumen</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                    ...
                    <!-- Lihat Gambar -->
                    <a href="<?php echo base_url('k3/detail_gbr/' . $k3->id_k3); ?>" target="_blank" style="margin-top:8px;><button
                            type=" button" class="btn btn-primary"><i class="fa-solid fa-circle-info"></i>
                        Gambar</button></a>
                    <!-- Lihat Gambar -->
                ...
                <td class="text-center">
                    ...
                    <!-- Edit -->
                    <a href="<?php echo base_url('k3/edit_k3/' . $k3->id_k3); ?>"><button type="button"
